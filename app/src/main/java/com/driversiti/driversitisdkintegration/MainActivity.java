        ...
        return new DriversitiEventListener("DrawerActivity") {
            ...
            public void onCarModeStatusChange(final CarModeEvent event) {
                ...
                Runnable runnable = new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(mContext, "event: " + event.getEventType().toString(), Toast.LENGTH_LONG);
                    }
                };
            ...
            public void onSpeedExceeded(final SpeedExceededEvent speedExceededEvent) {
                ...
                Runnable runnable = new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(mContext, "event: " + speedExceededEvent.getEventType().toString(), Toast.LENGTH_LONG);
                    }
                };
                postToUiThreadHelper(runnable);
            ...
            public void onSafeSpeedRestored(final SpeedRestoredEvent speedRestoredEvent) {
                ...
                Runnable runnable = new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(mContext, "event: " + speedRestoredEvent.getEventType().toString(), Toast.LENGTH_LONG);
                    }
                };
                postToUiThreadHelper(runnable);
